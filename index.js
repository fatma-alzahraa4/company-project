...
//   credentials: true,
// }
const allowedOrigins = [process.env.DASHBOARDLINK, process.env.LOCALHOST, process.env.WEBSITELINK, process.env.WEB_LINK, process.env.DASHBOARDLINK2, process.env.DASHBOARDLINK3, 'https://dashboard.hbs-group.xyz'];
